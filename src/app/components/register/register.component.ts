...
export class RegisterComponent implements OnInit {
  ...
  constructor(
    ...
    private postusers: ProfileService,
    private vand: BecomeVenderService,
  ...
  ngOnInit(): void {
    ...
    this.authService.user$.subscribe((profile) => {
      ...
      this.profileJson = profile?.['http://roletest.net/roles'];
    });
  }
  ...
  register_validation_messages = {
    ...
    StoreName: [{ type: 'required', message: 'Phone number is required' }],
  };
}
